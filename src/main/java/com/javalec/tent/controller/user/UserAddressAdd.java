...
/**
 * Servlet implementation class UserAddressAdd
 */
@WebServlet("/UserAddressAdd")
public class UserAddressAdd extends HttpServlet implements TentCommand {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserAddressAdd() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = userDao.userAddressAdd(uid, uaAddress, uaDetailAddress, uaZipcode, uaContent);
