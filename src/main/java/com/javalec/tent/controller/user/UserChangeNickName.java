...
/**
 * Servlet implementation class UserChangeNickName
 */
@WebServlet("/UserChangeNickName")
public class UserChangeNickName extends HttpServlet implements TentCommand {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserChangeNickName() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = userDao.userChangeNickName(uid, uNickName);
		if(result == 1) {
