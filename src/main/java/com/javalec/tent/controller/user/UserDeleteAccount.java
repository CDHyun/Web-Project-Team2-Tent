...
/**
 * Servlet implementation class UserDeleteAcount
 */
@WebServlet("/UserDeleteAccount")
public class UserDeleteAccount extends HttpServlet implements TentCommand {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = userDao.userDeleteAccount(uid, uPassword);
