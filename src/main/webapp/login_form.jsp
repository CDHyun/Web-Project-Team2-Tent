...
<body>
				...
				<div class="col-12 col-md-6">
					<div class="login_form mb-50">
						...
						<form id="user_login_form" method="post" action="login.do">
							...
							<button type="button" class="close" id="closeBtn" data-dismiss="modal" aria-label="Close"></button>
							<button type="button" id="login_btn" class="btn btn-primary btn-sm" onclick="loginCheck()">Login</button>
						</form>
						<!-- Forget Password -->
						<div class="forget_pass mt-15">
							<a href="#">Forget Password?</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
								href="sign_up.jsp">아직 회원이 아니신가요?</a>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Login Area End -->
	<button type="button" id="login_btn" class="btn btn-primary btn-sm"
